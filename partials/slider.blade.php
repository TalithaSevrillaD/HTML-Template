<div class="slider col align-self-center">
    <div class="container">
        <div id="WJSlider" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img src="images/slider1.jpg" alt="slide1" width="460" height="345">
              <div class="carousel-caption">
              </div>
            </div>
      
            <div class="item">
              <img src="images/slider2.jpg" alt="slide2" width="460" height="345">
              <div class="carousel-caption">
              </div>
            </div>
       
            <div class="item">
              <img src="images/slider3.jpg" alt="slide3" width="460" height="345">
              <div class="carousel-caption">
              </div>
            </div>
      
            <div class="item">
              <img src="images/slider5.png" alt="slide4" width="460" height="345">
              <div class="carousel-caption">
              </div>
            </div>
